...
export const MESSAGES = {
  zh: {
    ...
    markOptional: '标记为可选',
    mapLookup: '在地图上查找',
    mapLookupHint: '为这个活动补充地图坐标。可与标题不同，比如标题用中文、地图用英文。',
    mapLookupSearching: '正在查找…',
    mapLookupNoResults: '没有找到匹配的地点。试着换个写法（加上城市或英文名）。',
    mapLookupUse: '使用此地点',
    mapLookupCoords: '坐标',
    mapLookupClear: '清除坐标',
    mapLookupResolved: '已绑定地图坐标',
    mobileOpenSidebar: '行程输入',
    mobileCloseSidebar: '收起',
    kindSightseeing: '景点',
    kindFood: '餐饮',
    kindTransport: '交通',
    kindFlight: '航班',
  ...
  en: {
    ...
    mapLookup: 'Look up on map',
    mapLookupHint:
      'Attach map coordinates to this item. The map name can differ from the title — e.g. title in your own language, map lookup in English.',
    mapLookupSearching: 'Searching…',
    mapLookupNoResults: 'No matching place found. Try a different spelling (add city or English name).',
    mapLookupUse: 'Use this place',
    mapLookupCoords: 'Coords',
    mapLookupClear: 'Clear coords',
    mapLookupResolved: 'Map coordinates set',
    mobileOpenSidebar: 'Trip input',
    mobileCloseSidebar: 'Close',
